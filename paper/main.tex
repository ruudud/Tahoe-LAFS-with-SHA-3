...
the of writing, the current status of the competition is in it's final round
(or round 3), with only five remaining candidates. This result was not revealed
until a week before the submission of this paper, so we are focusing on all
round 2 candidates, which there are 14 of.  \cite{s_fedreg}.
