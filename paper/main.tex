...
a call to {\verb Update() }. This is also a hassle for a programmer who wants
to use the implementations found in \ac{SUPERCOP}
...
implementations which fail completely as hash functions, see section
\ref{sec:choosen_implementations} for details on the JH implementation.
