...
\paragraph{Sphlib} is a C and Java library made by Thomas Pornin
\footnote{\url{http://www.saphir2.com/sphlib/}}, which contains all the second
round \ac{SHA}-3 candidates. Some of the same implementations are also found in
