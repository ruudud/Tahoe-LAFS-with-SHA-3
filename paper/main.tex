...
As stated in Section \ref{sec:lengthextension}, none of the \ac{SHA}-3
...
further discussed in Chapter \ref{ch:discussion}.
...
implementations in \{SUPERCOP}. The results can be seen in appendix
