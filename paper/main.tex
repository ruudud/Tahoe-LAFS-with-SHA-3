...
created. This overhead should be about the same for all candidates, since the
...
\autoref{sec:chosen_implementations} for details on the JH implementation.
...
to achieve maximum speed.  The loss of one register will therefore give a
performance penalty.
...
Tahoe-\ac{LAFS} to upload a one gigabyte file, could improve by $5\%$ if the
