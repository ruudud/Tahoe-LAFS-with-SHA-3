...
ext_modules = [
    Extension("sha3lib.hash_functions.bmw.bmw_hash",
        [hashpath+"bmw/bmw_hash.pyx", hashpath+'bmw/BlueMidnightWish.c'],
        extra_compile_args=['-mssse3','-m32','-march=i386','-O','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.groestl.groestl_hash",
        ...
        extra_compile_args=['-mssse3','-m32','-march=pentium3','-O','-fomit-frame-pointer'],),
    Extension("sha3lib.hash_functions.echo.echo_hash",
        [hashpath+"echo/echo_hash.pyx", hashpath+'echo/sha3nist.c',
            hashpath+"echo/echo.c"],
        extra_compile_args=['-mssse3','-funroll-loops','-m32','-march=prescott','-O2','-fomit-frame-pointer']),
    ...
    Extension("sha3lib.hash_functions.skein.skein_hash",
        ...
        extra_compile_args=['-mssse3','-march=pentium2','-O2','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.luffa.luffa",
        [hashpath+"luffa/luffa.pyx", hashpath+'luffa/luffa_for_sse2.c'],
        extra_compile_args=['-mssse3','-msse2','-funroll-loops','-march=k8','-O3','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.shavite3.shavite3",
        [hashpath+"shavite3/shavite3.pyx", hashpath+'shavite3/SHAvite3.c'],
        extra_compile_args=['-mssse3','-funroll-loops','-march=i486','-O','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.simd.simd",
        [hashpath+"simd/simd.pyx",hashpath+"simd/vector.c",
            hashpath+"simd/nist.c"],
        extra_compile_args=['-mssse3','-m32','-march=barcelona','-O2','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.keccak.keccak",
        ...
        extra_compile_args=['-mssse3','-msse2','-march=barcelona','-O3','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.jh.jh_hash",
        [hashpath+"jh/jh_hash.pyx",hashpath+"jh/sha3nist.c",hashpath+"jh/jh.c"],
        extra_compile_args=['-mssse3','-m32','-march=core2','-O','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.fugue.fugue_hash",
        ...
        extra_compile_args=['-mssse3','-funroll-loops','-O','-fomit-frame-pointer']),
    Extension("sha3lib.hash_functions.shabal.shabal_hash",
        ...
        extra_compile_args=['-mssse3','-funroll-loops','-m32','-march=pentium2','-O','-fomit-frame-pointer']),
    ...
    Extension("sha3lib.hash_functions.hamsi.hamsi_hash",
        ...
        extra_compile_args=['-mssse3','-funroll-loops','-m32','-march=pentium-m','-O3','-fomit-frame-pointer']),
    ]
