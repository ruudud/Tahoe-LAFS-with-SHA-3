...
ext_modules = [
    ...
    Extension("sha3lib.hash_functions.simd.simd",
        ...
        extra_compile_args=['-m32','-march=barcelona','-O2','-fomit-frame-pointer']),
    ...
    Extension("sha3lib.hash_functions.jh.jh_hash",
        ...
        extra_compile_args=['-m32','-march=core2','-msse4.1','-O','-fomit-frame-pointer']),
    ...
    Extension("sha3lib.hash_functions.shabal.shabal_hash",
        ...
        extra_compile_args=['-funroll-loops','-m32','-march=pentium2','-O','-fomit-frame-pointer']),
