...
class ScaledTextData(Data):
    def __repr__(self):
        ...
        return 'chd=t:%s&chds=0,%s' % ('%7c'.join(encoded_data),
                                       str(max_value))
...
class Chart(object):
    ...
    def __init__(self, width, height, title=None, legend=None, colours=None,
            ...
            colours_within_series=None, custom_scaling=False):
        if type(self) == Chart:
            raise AbstractClassException('This is an abstract class')
        ...
        # Data for scaling.
        self.custom_scaling = custom_scaling # Text Format with Custom Scaling
